...
if (typeof window.YAHOO.lacuna.CreateSpecies == "undefined" || !window.YAHOO.lacuna.CreateSpecies) {
...
(function(){
    ...
    CreateSpecies.prototype = {
        handleCreate : function() {
            ...
            EmpireServ.update_species(data, {
                success : function(o) {
                    window.YAHOO.log(o, "info", "CreateSpecies");
                    this._found();
                },
                failure : function(o){
        ...
        _found : function() {
            ...
            EmpireServ.found({empire_id: this.empireId, api_key:Lib.ApiKey}, {
                success : function(o) {
                    window.YAHOO.log(o, "info", "CreateSpecies._found.success");
    ...
    window.YAHOO.lang.augmentProto(CreateSpecies, Util.EventProvider);

    Lacuna.CreateSpecies = CreateSpecies;
})();
window.YAHOO.register("createSpecies", window.YAHOO.lacuna.CreateSpecies, {version: "1", build: "0"});
