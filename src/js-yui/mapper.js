...
if (typeof window.YAHOO.lacuna.Mapper == "undefined" || !window.YAHOO.lacuna.Mapper) {
...
(function(){
    ...
    Map.prototype = {
        ...
        zoomIn : function() {
            //window.YAHOO.log("zooming in", "info", "Mapper.Map");
        ...
        zoomOut : function() {
            //window.YAHOO.log("zooming out", "info", "Mapper.Map");
    ...
    Lang.extend(Mapper.StarMap, Map, {
        ...
        getTileData : function(callback, x1, x2, y1, y2) {
            ...
            if((xDiff * yDiff) > MAX_STAR_AREA) { //if out of bounds split and try again
                ...
                //window.YAHOO.log(data, "debug", "StarMap.getTileData.requestData");
                ...
                Game.Services.Map.get_star_map({ args: {
                    ...
                    success : function(o){
                        //window.YAHOO.log(o, "debug", "StarMap.getTileData.get_stars.success");
    ...
    Mapper.TraditionalController = function( map ) {
        this.map = map;
        this.dd = new window.YAHOO.util.DragDrop(map.mapDiv, 'mapper' );
        ...
        if((map.maxZoom - map.minZoom) != 0) {
            ...
            var zoomSlider = window.YAHOO.widget.Slider.getVertSlider(
                sliderId,
                thumbId,
                0,
                zoomSize,
    ...
    window.YAHOO.lacuna.Mapper = Mapper;
})();
window.YAHOO.register("mapper", window.YAHOO.lacuna.Mapper, {version: "1", build: "0"});
