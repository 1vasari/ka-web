...
if (typeof window.YAHOO.lacuna.SMD == "undefined" || !window.YAHOO.lacuna.SMD) {
...
(function(){
    ...
    window.YAHOO.lacuna.SMD = { Services:smd };
})();
window.YAHOO.register("smd", window.YAHOO.lacuna.SMD, {version: "1", build: "0"});
