...
if (typeof window.YAHOO.lacuna.buildings.FoodReserve == "undefined" || !window.YAHOO.lacuna.buildings.FoodReserve) {
...
(function(){
    ...
    window.YAHOO.lang.extend(FoodReserve, window.YAHOO.lacuna.buildings.Building, {
        ...
        _getFoodTab : function() {
            ...
            return new window.YAHOO.widget.Tab({ label: "Food", content: [
        ...
        _getDumpTab : function() {
            ...
            this.dumpTab = new window.YAHOO.widget.Tab({ label: "Dump", contentEl: this.DumpGetDisplay(this.result.dump)});
            ...
            if(building) {
                ...
                if(amount > this.resources[type]) {
                    ...
                    this.service.dump({
                        ...
                        success : function(o){
                            window.YAHOO.log(o, "info", "FoodReserve.Dump.success");
                            this.rpcSuccess(o);
    ...
    window.YAHOO.lacuna.buildings.FoodReserve = FoodReserve;

})();
window.YAHOO.register("foodreserve", window.YAHOO.lacuna.buildings.FoodReserve, {version: "1", build: "0"});
