...
if (typeof window.YAHOO.lacuna.buildings.Park == "undefined" || !window.YAHOO.lacuna.buildings.Park) {
...
(function(){
    ...
    Lang.extend(Park, Lacuna.buildings.Building, {
        ...
        _getPartyTab : function() {
            ...
            this.partyTab = new window.YAHOO.widget.Tab({ label: "Party", contentEl: div});
        ...
        Party : function(e) {
            ...
            this.service.throw_a_party({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Park.Party.success");
    ...
    window.YAHOO.lacuna.buildings.Park = Park;

})();
window.YAHOO.register("park", window.YAHOO.lacuna.buildings.Park, {version: "1", build: "0"});
