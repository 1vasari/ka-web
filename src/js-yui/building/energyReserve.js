...
if (typeof window.YAHOO.lacuna.buildings.EnergyReserve == "undefined" || !window.YAHOO.lacuna.buildings.EnergyReserve) {
...
(function(){
    ...
    window.YAHOO.lang.extend(EnergyReserve, window.YAHOO.lacuna.buildings.Building, {
            ...
            if(building) {
                ...
                if(amount > planet.energy_stored) {
                    ...
                    this.service.dump({
                        ...
                        success : function(o){
                            window.YAHOO.log(o, "info", "EnergyReserve.Dump.success");
    ...
    window.YAHOO.lacuna.buildings.EnergyReserve = EnergyReserve;

})();
window.YAHOO.register("energyreserve", window.YAHOO.lacuna.buildings.EnergyReserve, {version: "1", build: "0"});
