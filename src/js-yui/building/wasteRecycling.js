...
if (typeof window.YAHOO.lacuna.buildings.WasteRecycling == "undefined" || !window.YAHOO.lacuna.buildings.WasteRecycling) {
...
(function(){
    ...
    Lang.extend(WasteRecycling, Lacuna.buildings.Building, {
        ...
        _getRecycleTab : function() {
            if(this.result.recycle.can) {
                this.recycleTab = new window.YAHOO.widget.Tab({ label: "Recycle", contentEl: this.RecycleGetDisplay(this.result.recycle)});
            }
            else if(this.result.recycle.seconds_remaining) {
                this.recycleTab = new window.YAHOO.widget.Tab({label: "Recycle", contentEl: this.RecycleGetTimeDisplay(this.result.recycle)});
            ...
            if(planet) {
                ...
                if(total > planet.waste_stored) {
                    ...
                    this.service.recycle({
                        ...
                        success : function(o){
                            window.YAHOO.log(o, "info", "WasteRecycling.Recycle.success");
        ...
        RecycleSubsidize : function() {
            ...
            this.service.subsidize_recycling({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "WasteRecycling.RecycleSubsidize.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
    ...
    window.YAHOO.lacuna.buildings.WasteRecycling = WasteRecycling;

})();
window.YAHOO.register("wasterecycling", window.YAHOO.lacuna.buildings.WasteRecycling, {version: "1", build: "0"});
