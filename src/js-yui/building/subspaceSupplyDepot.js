...
if (typeof window.YAHOO.lacuna.buildings.SubspaceSupplyDepot == "undefined" || !window.YAHOO.lacuna.buildings.SubspaceSupplyDepot) {
...
(function(){
    ...
    window.YAHOO.lang.extend(SubspaceSupplyDepot, Lacuna.buildings.Building, {
        ...
        _getTransmitTab : function() {
            ...
            var tab = new window.YAHOO.widget.Tab({ label: "Transmit Resources", contentEl: div });
        ...
        Transmit : function(e, opt) {
            ...
            this.service[opt.method]({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "SubspaceSupplyDepot.Transmit.success");
...
window.YAHOO.register("SubspaceSupplyDepot", window.YAHOO.lacuna.buildings.SubspaceSupplyDepot, {version: "1", build: "0"});
