...
if (typeof window.YAHOO.lacuna.buildings.MiningMinistry == "undefined" || !window.YAHOO.lacuna.buildings.MiningMinistry) {
...
(function(){
    ...
    Lang.extend(MiningMinistry, Lacuna.buildings.Building, {
        ...
        _getPlatformTab : function() {
            this.platformTab = new window.YAHOO.widget.Tab({ label: "Platforms", content: [
        ...
        _getShipsTab : function() {
            this.shipsTab = new window.YAHOO.widget.Tab({ label: "Ships", content: [
        ...
        _getAbandonAllPlatformsTab : function() {
            this.probesTab = new window.YAHOO.widget.Tab({ label: "Abandon All Platforms", content: [
                    '<div>',
            ...
            if(e.newValue) {
                if(!this.platforms) {
                    ...
                    this.service.view_platforms({session_id:Game.GetSession(),building_id:this.building.id}, {
                        success : function(o){
                            window.YAHOO.log(o, "info", "MiningMinistry.view_platforms.success");
        ...
        MiningMinistryPlatformAbandon : function() {
            if(confirm(["Are you sure you want to Abandon the mining platform at  ",this.Platform.asteroid.name,"?"].join(''))) {
                ...
                this.Self.service.abandon_platform({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "MiningMinistry.MiningMinistryPlatformAbandon.success");
                        require('js/actions/menu/loader').hide();
        ...
        MiningMinistryShipsView : function() {
            ...
            this.service.view_ships({session_id:Game.GetSession(),building_id:this.building.id}, {
                success : function(o){
                    window.YAHOO.log(o, "info", "MiningMinistry.MiningMinistryShipsView.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
        ...
        MiningMinistryShipsAdd : function() {
            ...
            this.Self.service.add_cargo_ship_to_fleet({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "MiningMinistry.MiningMinistryShipsAdd.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
                    this.MiningMinistryShipsView();
        ...
        MiningMinistryShipsRemove : function() {
            ...
            this.Self.service.remove_cargo_ship_from_fleet({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "MiningMinistry.MiningMinistryShipsRemove.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
                    this.MiningMinistryShipsView();
        ...
        AbandonAllPlatforms : function(e) {
            if(confirm("Are you sure you want to abandon all platforms controlled by this Mining Ministry?")) {
                ...
                this.service.mass_abandon_platform({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "Observatory.AbandonAllPlatforms.mass_abandon_platform.success");
                        require('js/actions/menu/loader').hide();
                        this.rpcSuccess(o);
                        this.probes = null;
    ...
    window.YAHOO.lacuna.buildings.MiningMinistry = MiningMinistry;

})();
window.YAHOO.register("miningministry", window.YAHOO.lacuna.buildings.MiningMinistry, {version: "1", build: "0"});
