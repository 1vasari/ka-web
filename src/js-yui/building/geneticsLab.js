...
if (typeof window.YAHOO.lacuna.buildings.GeneticsLab == "undefined" || !window.YAHOO.lacuna.buildings.GeneticsLab) {
...
(function(){
    ...
    Lang.extend(GeneticsLab, Lacuna.buildings.Building, {
        ...
        _getLabTab : function() {
            this.tab = new window.YAHOO.widget.Tab({ label: "Lab", content: [
       ...
       _getRenameTab : function() {
            ...
            this.tab = new window.YAHOO.widget.Tab({ label: "Rename Species", contentEl: div});
        ...
        RenameSpecies : function(e) {
            ...
            this.service.rename_species({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "GeneticsLab.rename_species.success");
                    btn.disabled = false;
    ...
    window.YAHOO.lacuna.buildings.GeneticsLab = GeneticsLab;

})();
window.YAHOO.register("geneticslab", window.YAHOO.lacuna.buildings.GeneticsLab, {version: "1", build: "0"});
