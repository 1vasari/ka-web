...
if (typeof window.YAHOO.lacuna.buildings.Security == "undefined" || !window.YAHOO.lacuna.buildings.Security) {
...
(function(){
    ...
    Lang.extend(Security, Lacuna.buildings.Building, {
        ...
        _getPrisonersTab : function() {
            ...
            this.prisonersTab = new window.YAHOO.widget.Tab({ label: "Prisoners", content: [
                '<div>',
        ...
        _getSpiesTab : function() {
            this.spiesTab = new window.YAHOO.widget.Tab({ label: "Foreign Spies", content: [
                '<div>',
            ...
            if(e.newValue) {
                if(!this.prisoners) {
                    ...
                    this.service.view_prisoners({session_id:Game.GetSession(),building_id:this.building.id}, {
                        success : function(o){
                            window.YAHOO.log(o, "info", "Security.Security.view_prisoners.success");
        ...
        PrisonersHandlePagination : function(newState) {
            ...
            this.service.view_prisoners({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Security.PrisonersHandlePagination.view_prisoners.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
                    this.prisoners = o.result.prisoners;
                    this.PrisonersPopulate();
        ...
        PrisonersExecute : function() {
            if(confirm(["Are you sure you want to execute ",this.Prisoner.name,"?"].join(''))) {
                ...
                this.Self.service.execute_prisoner({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "Security.PrisonersExecute.success");
                        require('js/actions/menu/loader').hide();
        ...
        PrisonersRelease : function() {
            if(confirm(["Are you sure you want to release ",this.Prisoner.name,"?"].join(''))) {
                ...
                this.Self.service.release_prisoner({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "Security.PrisonersRelease.success");
                        require('js/actions/menu/loader').hide();
                        this.Self.rpcSuccess(o);
                        var prisoners = this.Self.prisoners;
                        for(var i=0; i<prisoners.length; i++) {
            ...
            if(e.newValue) {
                if(!this.spies) {
                    ...
                    this.service.view_foreign_spies({session_id:Game.GetSession(),building_id:this.building.id}, {
                        success : function(o){
                            window.YAHOO.log(o, "info", "Security.Security.view_foreign_spies.success");
                            require('js/actions/menu/loader').hide();
                            this.rpcSuccess(o);
        ...
        SpyHandlePagination : function(newState) {
            ...
            this.service.view_foreign_spies({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Security.SpyHandlePagination.view_foreign_spies.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
                    this.spies = o.result.spies;
                    this.SpyPopulate();
    ...
    window.YAHOO.lacuna.buildings.Security = Security;

})();
window.YAHOO.register("Security", window.YAHOO.lacuna.buildings.Security, {version: "1", build: "0"});
