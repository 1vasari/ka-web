...
if (typeof window.YAHOO.lacuna.buildings.SpacePort === "undefined" || !window.YAHOO.lacuna.buildings.SpacePort) {
...
(function(){
    ...
    Lang.extend(SpacePort, Lacuna.buildings.Building, {
        ...
        _getTravelTab : function() {
            this.travelTab = new window.YAHOO.widget.Tab({ label: "Travelling", content: [
                '<div>',
        ...
        _getViewTab : function() {
            this.viewShipsTab = new window.YAHOO.widget.Tab({ label: "View", content: [
                '<div>',
        ...
        _getOrbitingTab : function() {
            this.viewOrbitingTab = new window.YAHOO.widget.Tab({ label: "Foreign Orbiting", content: [
                '<div>',
                '    <ul class="shipHeader shipInfo clearafter">',
                '        <li class="shipTypeImage">&nbsp;</li>',
                '        <li class="shipName">Name</li>',
        ...
        _getForeignTab : function() {
            this.foreignShipsTab = new window.YAHOO.widget.Tab({ label: "Incoming", content: [
                '<div>',
                '    <ul class="shipHeader shipInfo clearafter">',
                '        <li class="shipTypeImage">&nbsp;</li>',
                '        <li class="shipName">Name</li>',
        ...
        _getLogsTab : function() {
            this.battleLogsTab = new window.YAHOO.widget.Tab({ label: "Battle Logs", content: [
                '<div>',
        ...
        _getSendTab : function() {
            this.sendTab = new window.YAHOO.widget.Tab({ label: "Send", content: [
                '<div id="sendShipPick">',
        ...
        _getSendFleetTab : function() {
            ...
            var earlyset  = true;
            this.sendFleetTab = new window.YAHOO.widget.Tab({ label: "Fleet", content: [
                '<div class="yui-g">',
            ...
            if(e.newValue) {
                if(!this.shipsTravelling) {
                    ...
                    this.service.view_ships_travelling({session_id:Game.GetSession(),building_id:this.building.id,page_number:1}, {
                        success : function(o){
                            window.YAHOO.log(o, "info", "SpacePort.view_ships_travelling.success");
            ...
            if(e.newValue) {
                if(!this.shipsView) {
                    ...
                    this.service.view_all_ships({session_id:Game.GetSession(),building_id:this.building.id,paging:{page_number:1}}, {
                        success : function(o){
                            window.YAHOO.log(o, "info", "SpacePort.view_all_ships.success");
                            require('js/actions/menu/loader').hide();
                            this.rpcSuccess(o);
                            this.shipsView = {
            ...
            if(e.newValue) {
                if(!this.shipsForeign) {
                    ...
                    this.service.view_foreign_ships({session_id:Game.GetSession(),building_id:this.building.id,page_number:1}, {
                        success : function(o){
                            window.YAHOO.log(o, "info", "SpacePort.view_foreign_ships.success");
                            require('js/actions/menu/loader').hide();
                            this.rpcSuccess(o);
                            this.shipsForeign = {
                                number_of_ships: o.result.number_of_ships,
            ...
            if(e.newValue) {
                if(!this.battleLogs) {
                    ...
                    this.service.view_battle_logs({session_id:Game.GetSession(),building_id:this.building.id}, {
                        success : function(o){
                            window.YAHOO.log(o, "info", "SpacePort.view_battle_logs.success");
                            require('js/actions/menu/loader').hide();
                            this.rpcSuccess(o);
                            this.battleLogs = {
        ...
        ShipHandlePagination : function(newState) {
            ...
            this.service.view_ships_travelling({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "SpacePort.ShipHandlePagination.view_ships_travelling.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
                    this.shipsTravelling = {
                        number_of_ships_travelling: o.result.number_of_ships_travelling,
        ...
        ViewHandlePagination : function(newState) {
            ...
            this.service.view_all_ships({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "SpacePort.ViewHandlePagination.view_all_ships.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
                    this.shipsView = {
                        number_of_ships: o.result.number_of_ships,
        ...
        ShipNameSave : function(e) {
            ...
            this.Self.service.name_ship({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "SpacePort.ShipNameSave.success");
                    require('js/actions/menu/loader').hide();
        ...
        ShipScuttle : function(e, matchedEl, container) {
            if(confirm(["Are you sure you want to Scuttle ",this.Ship.name,"?"].join(''))) {
                ...
                this.Self.service.scuttle_ship({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "SpacePort.ShipScuttle.success");
                        require('js/actions/menu/loader').hide();
                        this.Self.rpcSuccess(o);
...
//                 );
    ...
    window.YAHOO.lacuna.buildings.SpacePort = SpacePort;

})();
window.YAHOO.register("spaceport", window.YAHOO.lacuna.buildings.SpacePort, {version: "1", build: "0"});
