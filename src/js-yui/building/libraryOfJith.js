...
if (typeof window.YAHOO.lacuna.buildings.LibraryOfJith == "undefined" || !window.YAHOO.lacuna.buildings.LibraryOfJith) {
...
(function(){
    ...
    Lang.extend(LibraryOfJith, Lacuna.buildings.Building, {
        ...
        _getTab : function() {
            this.libraryTab = new window.YAHOO.widget.Tab({ label: "Species Library", content: [
                    '<div>',
        ...
        createFind : function() {
            ...
            var oTextboxList = new window.YAHOO.lacuna.TextboxList("lojFindEmpire", dataSource, { //config options
    ...
    window.YAHOO.lacuna.buildings.LibraryOfJith = LibraryOfJith;

})();
window.YAHOO.register("libraryofjith", window.YAHOO.lacuna.buildings.LibraryOfJith, {version: "1", build: "0"});
