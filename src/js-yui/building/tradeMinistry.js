...
if (typeof window.YAHOO.lacuna.buildings.Trade == "undefined" || !window.YAHOO.lacuna.buildings.Trade) {
...
this.push = new window.YAHOO.widget.Tab({ label: "Push", content: [
...
_getAvailableTradesTab : function() {
                   this.avail = new window.YAHOO.widget.Tab({ label: "Trades", content: [
                           '<div>',
...
_getMyTradesTab : function() {
                  this.mine = new window.YAHOO.widget.Tab({ label: "My Trades", content: ['<div class="myTrades">',
                          '    <ul class="tradeHeader tradeInfo clearafter">',
...
_getAddTradeTab : function() {
                 this.add = new window.YAHOO.widget.Tab({ label: "Add Trade", content: [
...
_getSupplyChainTab : function() {
    ...
    this.supplyChainTab = new window.YAHOO.widget.Tab({ label: "Supply Chains", content: [
...
_getSupplyShipsTab : function() {
    this.supplyShipsTab = new window.YAHOO.widget.Tab({ label: "Supply Ships", content: [
...
_getWasteChainTab : function() {
    this.wasteChainTab = new window.YAHOO.widget.Tab({ label: "Waste Chain", content: [
    ...
    return this.wasteChainTab;
        ...
        getAvailableTrades : function(e) {
            if(e.newValue) {
                ...
                this.service.view_market(data, {
                    success : function(o){
                        window.YAHOO.log(o, "info", "Trade.view_available_trades.success");
                        require('js/actions/menu/loader').hide();
                        this.rpcSuccess(o);
        ...
        AvailableAccept : function() {
            ...
            this.Self.service.accept_from_market({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.accept_trade.success");
        ...
        getMyTrades : function(e) {
            if(e.newValue) {
                ...
                this.service.view_my_market({session_id:Game.GetSession(),building_id:this.building.id,page_number:1}, {
                    success : function(o){
                        window.YAHOO.log(o, "info", "Trade.view_my_trades.success");
                        require('js/actions/menu/loader').hide();
                        this.rpcSuccess(o);
        ...
        MineWithdraw : function() {
            if(confirm(['Are you sure you want to withdraw the trade asking for ', this.Trade.ask, ' essentia and offering ', this.Trade.offer.join(', '),'?'].join(''))) {
                ...
                this.Self.service.withdraw_from_market({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "Trade.withdraw_trade.success");
                        this.Self.rpcSuccess(o);
        ...
        viewSupplyChainInfo : function(e) {
            ...
            if ( !this.supply_chains ) {
                ...
                this.service.view_supply_chains({session_id:Game.GetSession(),building_id:this.building.id}, {
                    success : function(o){
                        window.YAHOO.log(o, "info", "Trade.viewSupplyChainList.success");
                        require('js/actions/menu/loader').hide();
                        this.rpcSuccess(o);
        ...
        SupplyChainAddNew : function() {
            ...
            this.Self.service.create_supply_chain({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.SupplyChainAddNew.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
        ...
        SupplyChainUpdate : function() {
            ...
            this.Self.service.update_supply_chain({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.SupplyChainUpdate.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
        ...
        SupplyChainRemove : function() {
            ...
            this.Self.service.delete_supply_chain({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.SupplyChainRemove.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
        ...
        viewSupplyShips : function(e) {
            ...
            if ( !this.supply_chain_ships ) {
                ...
                this.service.get_supply_ships({session_id:Game.GetSession(),building_id:this.building.id}, {
                    success : function(o){
                        window.YAHOO.log(o, "info", "Trade.viewSupplyShipsInfo.success");
                        request_count--;
                        if ( request_count == 0 ) {
                            require('js/actions/menu/loader').hide();
                        }
        ...
        SupplyChainShipAdd : function() {
            ...
            this.Self.service.add_supply_ship_to_fleet({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.SupplyChainShipAdd.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
        ...
        SupplyChainShipRemove : function() {
            ...
            this.Self.service.remove_supply_ship_from_fleet({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.SupplyChainShipRemove.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
                    var ships = this.Self.supply_chain_ships;
                    for(var i=0; i<ships.length; i++) {
        ...
        WasteChainDetails : function() {
            ...
            this.service.view_waste_chains({session_id:Game.GetSession(),building_id:this.building.id}, {
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.WasteChainDetails.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
        ...
        WasteChainUpdateWasteHour : function() {
            ...
            this.Self.service.update_waste_chain({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.WasteChainUpdateWasteHour.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
        ...
        WasteChainShipsView : function() {
            ...
            this.service.get_waste_ships({session_id:Game.GetSession(),building_id:this.building.id}, {
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.WasteChainShipsView.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
        ...
        WasteChainShipAdd : function() {
            ...
            this.Self.service.add_waste_ship_to_fleet({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.WasteChainShipAdd.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
        ...
        WasteChainShipRemove : function() {
            ...
            this.Self.service.remove_waste_ship_from_fleet({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Trade.WasteChainShipRemove.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
                    var ships = this.Self.waste_chain_ships;
                    for(var i=0; i<ships.length; i++) {
...
window.YAHOO.register("trade", window.YAHOO.lacuna.buildings.Trade, {version: "1", build: "0"});
