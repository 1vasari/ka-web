...
if (typeof window.YAHOO.lacuna.buildings.Development == "undefined" || !window.YAHOO.lacuna.buildings.Development) {
...
(function(){
    ...
    Lang.extend(Development, Lacuna.buildings.Building, {
        ...
        _getQueueTab : function() {
            ...
            var tab = new window.YAHOO.widget.Tab({ label: "Build Queue", contentEl: div});
        ...
        DevCancelAll : function(e) {
            ...
            this.service.cancel_build(
                ...
                success : function(o) {
                    window.YAHOO.log(o, "info", "Development.DevCancelAll.success");
        ...
        DevCancelOneBuild : function(e) {
            ...
            this.Self.service.cancel_build({ args: {
                ...
                success : function(o) {
                    window.YAHOO.log(o, "info", "Development.DevCancelOneBuild.success");
                    require('js/actions/menu/loader').hide();
        ...
        DevSubsidizeOneBuild : function(e) {
            ...
            this.Self.service.subsidize_one_build({ args: {
                ...
                success : function(o) {
                    window.YAHOO.log(o, "info", "Development.DevSubsidizeOneBuild.success");
                    require('js/actions/menu/loader').hide();
        ...
        DevSubsidize : function(e) {
            ...
            this.service.subsidize_build_queue({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Development.DevSubsidize.success");
                    require('js/actions/menu/loader').hide();
                    var e = Game.EmpireData.essentia*1;
                    Game.EmpireData.essentia = e - o.result.essentia_spent*1;
                    this.rpcSuccess(o);
    ...
    window.YAHOO.lacuna.buildings.Development = Development;

})();
window.YAHOO.register("development", window.YAHOO.lacuna.buildings.Development, {version: "1", build: "0"});
