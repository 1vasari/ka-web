...
if (typeof window.YAHOO.lacuna.buildings.SpaceStationLab == "undefined" || !window.YAHOO.lacuna.buildings.SpaceStationLab) {
...
(function(){
    ...
    Lang.extend(SpaceStationLab, Lacuna.buildings.Building, {
        ...
        _getPlanTab : function() {
            ...
            return new window.YAHOO.widget.Tab({ label: "Make Plan", content: [
...
window.YAHOO.register("spacestationlab", window.YAHOO.lacuna.buildings.SpaceStationLab, {version: "1", build: "0"});
