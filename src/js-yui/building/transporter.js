...
if (typeof window.YAHOO.lacuna.buildings.Transporter == "undefined" || !window.YAHOO.lacuna.buildings.Transporter) {
...
(function(){
    ...
    Lang.extend(Transporter, Lacuna.buildings.Building, {
        ...
        _getOneForOneTab : function() {
            this.oneForOne = new window.YAHOO.widget.Tab({ label: "One For One", content: ['<div class="transporterOneForOne">',
        ...
        _getAvailTab : function() {
            this.avail = new window.YAHOO.widget.Tab({ label: "Available Trades", content: [
                '<div>',
        ...
        Trade : function() {
            ...
            if(data.quantity > this.transport.max) {
                ...
                this.service.trade_one_for_one(data, {
                    success : function(o){
                        window.YAHOO.log(o, "info", "Transporter.Trade.success");
                        this.rpcSuccess(o);
...
window.YAHOO.register("transporter", window.YAHOO.lacuna.buildings.Transporter, {version: "1", build: "0"});
