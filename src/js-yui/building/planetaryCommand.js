...
if (typeof window.YAHOO.lacuna.buildings.PlanetaryCommand == "undefined" || !window.YAHOO.lacuna.buildings.PlanetaryCommand) {
...
(function(){
    ...
    Lang.extend(PlanetaryCommand, Lacuna.buildings.Building, {
        ...
        _getPlanetTab : function() {
            ...
            var tab = new window.YAHOO.widget.Tab({ label: "Planet", content: [
        ...
        _getAbandonTab : function() {
            this.abandonTab = new window.YAHOO.widget.Tab({ label: "Abandon", content: ['<div>',
        ...
        _getRenameTab : function() {
            this.renameTab = new window.YAHOO.widget.Tab({ label: "Rename", content: ['<div><ul>',
        ...
        _getPlanTab : function() {
            this.planTab = new window.YAHOO.widget.Tab({ label: "Plans", content: [
        ...
        _getResourcesTab : function() {
            ...
            this.resourcesTab = new window.YAHOO.widget.Tab({ label: "Resources", content: [
                    '<div class="yui-g buildingDetailsExtra">',
                    '    <div class="yui-u first">',
                    '        <ul class="buildingDetailsPC">',
                    food_items,
        ...
        _getNotesTab : function() {
            ...
            this.notesTab = new window.YAHOO.widget.Tab({ label: "Notes", content: [
            '<div id="pccNotes">',
        ...
        Abandon : function() {
            ...
            if(confirm(['Are you sure you want to abandon ',cp.name,'?'].join(''))) {
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "PlanetaryCommand.abandon.success");
                    this.rpcSuccess(o);
        ...
        Rename : function() {
            ...
            Game.Services.Body.rename({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "PlanetaryCommand.Rename.success");
...
window.YAHOO.register("planetarycommand", window.YAHOO.lacuna.buildings.PlanetaryCommand, {version: "1", build: "0"});
