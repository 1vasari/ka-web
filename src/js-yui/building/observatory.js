...
if (typeof window.YAHOO.lacuna.buildings.Observatory == "undefined" || !window.YAHOO.lacuna.buildings.Observatory) {
...
(function(){
    ...
    Lang.extend(Observatory, Lacuna.buildings.Building, {
        ...
        _getProbesTab : function() {
            this.probesTab = new window.YAHOO.widget.Tab({ label: "Probes", content: [
                    '<div>',
        ...
        _getAbandonAllProbesTab : function() {
            this.probesTab = new window.YAHOO.widget.Tab({ label: "Abandon All Probes", content: [
                    '<div>',
            ...
            if(e.newValue) {
                if(!this.probes) {
                    ...
                    this.service.get_probed_stars({session_id:Game.GetSession(),building_id:this.building.id,page_number:1}, {
                        success : function(o){
                            window.YAHOO.log(o, "info", "Observatory.get_probed_stars.success");
        ...
        ProbesHandlePagination : function(newState) {
            ...
            this.service.get_probed_stars({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Observatory.ProbesHandlePagination.get_probed_stars.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
                    this.probes = o.result.stars;
            ...
            if(container.Star) {
                if(confirm(["Are you sure you want to abandon the probe at ",container.Star.name,"?"].join(''))) {
                    ...
                    this.service.abandon_probe({
                        ...
                        success : function(o){
                            window.YAHOO.log(o, "info", "Observatory.ProbeAction.abandon_probe.success");
                            require('js/actions/menu/loader').hide();
                            this.rpcSuccess(o);
        ...
        AbandonAllProbes : function(e) {
            if(confirm("Are you sure you want to abandon all probes controlled by this Observatory?")) {
                ...
                this.service.abandon_all_probes({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "Observatory.AbandonAllProbes.abandon_all_probes.success");
                        require('js/actions/menu/loader').hide();
                        this.rpcSuccess(o);
                        this.probes = null;
    ...
    window.YAHOO.lacuna.buildings.Observatory = Observatory;

})();
window.YAHOO.register("Observatory", window.YAHOO.lacuna.buildings.Observatory, {version: "1", build: "0"});
