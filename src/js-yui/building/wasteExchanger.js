...
if (typeof window.YAHOO.lacuna.buildings.WasteExchanger == "undefined" || !window.YAHOO.lacuna.buildings.WasteExchanger) {
...
(function(){
    ...
    Lang.extend(WasteExchanger, Lacuna.buildings.Building, {
            ...
            if(planet) {
                ...
                if(total > planet.waste_stored) {
                    ...
                    this.service.recycle({
                        ...
                        success : function(o){
                            window.YAHOO.log(o, "info", "WasteExchanger.Recycle.success");
        ...
        RecycleSubsidize : function() {
            ...
            this.service.subsidize_recycling({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "WasteExchanger.RecycleSubsidize.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
    ...
    window.YAHOO.lacuna.buildings.WasteExchanger = WasteExchanger;

})();
window.YAHOO.register("wasteexchanger", window.YAHOO.lacuna.buildings.WasteExchanger, {version: "1", build: "0"});
