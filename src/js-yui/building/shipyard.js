...
if (typeof window.YAHOO.lacuna.buildings.Shipyard == "undefined" || !window.YAHOO.lacuna.buildings.Shipyard) {
...
(function(){
    ...
    Lang.extend(Shipyard, Lacuna.buildings.Building, {
        ...
        _getQueueTab : function() {
            ...
            var queueTab = new window.YAHOO.widget.Tab({ label: "Build Queue", contentEl:div });
        ...
        _getBuildTab : function() {
            var buildTab = new window.YAHOO.widget.Tab({ label: "Build Ships", content: [
                '<div>',
        ...
        getBuild : function() {
            if(!this.ships) {
                ...
                this.service.get_buildable({session_id:Game.GetSession(),building_id:this.building.id}, {
                    success : function(o){
                        window.YAHOO.log(o, "info", "Shipyard.getBuild.get_buildable.success");
        ...
        getQueue : function() {
            if(!this.ship_build_queue) {
                ...
                this.service.view_build_queue({session_id:Game.GetSession(),building_id:this.building.id,page_number:1}, {
                    success : function(o){
                        window.YAHOO.log(o, "info", "Shipyard.getQueue.view_build_queue.success");
                        require('js/actions/menu/loader').hide();
                        this.rpcSuccess(o);
        ...
        SubsidizeBuildQueue : function() {
            ...
            this.service.subsidize_build_queue({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Shipyard.SubsidizeBuildQueue.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
        ...
        ShipBuild : function(e) {
            ...
            this.Self.service.build_ships({
                ...
                success : function(o){
                    ...
                    window.YAHOO.lacuna.MapPlanet.RefreshWithData(o);
    ...
    window.YAHOO.lacuna.buildings.Shipyard = Shipyard;

})();
window.YAHOO.register("shipyard", window.YAHOO.lacuna.buildings.Shipyard, {version: "1", build: "0"});
