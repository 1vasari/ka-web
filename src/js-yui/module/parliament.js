...
if (typeof window.YAHOO.lacuna.modules.Parliament == "undefined" || !window.YAHOO.lacuna.modules.Parliament) {
...
(function(){
    ...
    Lang.extend(Parliament, Lacuna.buildings.Building, {
        ...
        _getLawsTab : function() {
            var tab = new window.YAHOO.widget.Tab({ label: "Laws", content: [
                '<div>',
        ...
        _getCreateTab : function() {
            ...
            var tab = new window.YAHOO.widget.Tab({ label: "Propose", content: [
        ...
        CreateStarSearch : function(id) {
            ...
            var oTextboxList = new window.YAHOO.lacuna.TextboxList(id, dataSource, { //config options
...
window.YAHOO.register("Parliament", window.YAHOO.lacuna.modules.Parliament, {version: "1", build: "0"});
