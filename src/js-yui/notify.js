...
if (typeof window.YAHOO.lacuna.Notify == "undefined" || !window.YAHOO.lacuna.Notify) {
    ...
    Notify.prototype = {
        build : function() {
            if (!this.Display) {
                ...
                this.Display = new window.YAHOO.widget.Panel("notify", {
...
window.YAHOO.register("notify", window.YAHOO.lacuna.Notify, {version: "1", build: "0"});
