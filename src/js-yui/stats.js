...
if (typeof window.YAHOO.lacuna.Stats == "undefined" || !window.YAHOO.lacuna.Stats) {
    ...
    Stats.prototype = {
        build: _.once(function() {
            ...
            this.Panel.renderEvent.subscribe(function(){
                ...
                this.tabView = new window.YAHOO.widget.TabView("statsTabs");
                ...
                this.generalTabView = new window.YAHOO.widget.TabView("statsGeneralTabs", {orientation:"left"});
        ...
        getServerStats : function(){
            ...
            Util.Connect.asyncRequest('GET', 'server_overview.json', {
                success: function(o) {
                    window.YAHOO.log(o, "info", "Stats.populateServerStats.success");
...
EmpireStats : function(){
                  if(this.EmpireTable) {
                      ...
                      this.EmpireData.responseType = window.YAHOO.util.XHRDataSource.TYPE_JSON;
...
totalRecords: "result.total_empires", // Access to value in the server response
              pageNumber: "result.page_number"
                      ...
                      if(eHt > 375) { eHt = 375; }
                      this.EmpireTable = new window.YAHOO.widget.ScrollingDataTable("statsEmpireTable", this.EmpireColumns, this.EmpireData, {
width:"100%",
height:eHt + "px",
initialRequest: Lang.JSON.stringify({
    ...
    "params": [
                    ...
                    dynamicData: true,
                    sortedBy : {key:"empire_size", dir:window.YAHOO.widget.DataTable.CLASS_DSC},
                    paginator: new window.YAHOO.widget.Paginator({ rowsPerPage:25, containers:'statsEmpirePaginator' }),
                ...
                this.EmpireTable.set("generateRequest", function(oState, oSelf) {
                    ...
                    var sort = encodeURIComponent((oState.sortedBy) ? oState.sortedBy.key : oSelf.getColumnSet().keys[0].getKey()),
                        dir = (oState.sortedBy && oState.sortedBy.dir === window.YAHOO.widget.DataTable.CLASS_DESC) ? "desc" : "asc",
        ...
        EmpireFindCreate : function() {
            ...
            var oTextboxList = new window.YAHOO.lacuna.TextboxList("statsEmpireFind", dataSource, { //config options
        ...
        AllianceStats : function(){
            if(this.AllianceTable) {
                ...
                this.AllianceData.responseType = window.YAHOO.util.XHRDataSource.TYPE_JSON;
                ...
                if (aHt > 375 ) { aHt = 375; }
                this.AllianceTable = new window.YAHOO.widget.ScrollingDataTable("statsAllianceTable", this.AllianceColumns, this.AllianceData, {
                    width:"100%",
                    height:aHt + "px",
                    initialRequest: Lang.JSON.stringify({
                            "id": window.YAHOO.rpc.Service._requestId++,
                    ...
                    dynamicData: true,
                    sortedBy : {key:"influence", dir:window.YAHOO.widget.DataTable.CLASS_DSC},
                    paginator: new window.YAHOO.widget.Paginator({ rowsPerPage:25, containers:'statsAlliancePaginator' }),
                    selectionMode:"single"
                } );
        ...
        AllianceFindCreate : function() {
            ...
            var oTextboxList = new window.YAHOO.lacuna.TextboxList("statsAllianceFind", dataSource, { //config options
                maxResultsDisplayed: 10,
                minQueryLength:3,
                multiSelect:false,
                forceSelection:true,
        ...
        ColonyStats : function(){
            if(this.ColonyTable) {
                ...
                this.ColonyData.responseType = window.YAHOO.util.XHRDataSource.TYPE_JSON;
                ...
                if(cHt > 410) { cHt = 410; }
                this.ColonyTable = new window.YAHOO.widget.ScrollingDataTable("statsColonyTable", this.ColonyColumns, this.ColonyData, {
                    width:"100%",
                    height:cHt + "px",
                    initialRequest: Lang.JSON.stringify({
                            "id": window.YAHOO.rpc.Service._requestId++,
                    ...
                    dynamicData: true,
                    sortedBy : {key:"population", dir:window.YAHOO.widget.DataTable.CLASS_DSC},
                    selectionMode:"single"
                } );
        ...
        SpyStats : function(){
            if(this.SpyTable) {
                ...
                this.SpyData.responseType = window.YAHOO.util.XHRDataSource.TYPE_JSON;
                ...
                if(sHt > 410) { sHt = 410; }
                this.SpyTable = new window.YAHOO.widget.ScrollingDataTable("statsSpyTable", this.SpyColumns, this.SpyData, {
                    width:"100%",
                    height:sHt + "px",
                    initialRequest: Lang.JSON.stringify({
                            "id": window.YAHOO.rpc.Service._requestId++,
                    ...
                    dynamicData: true,
                    sortedBy : {key:"level", dir:window.YAHOO.widget.DataTable.CLASS_DSC},
                    selectionMode:"single"
                } );
        ...
        WeeklyMedalStats : function(){
            if(this.WeeklyMedalTable) {
                ...
                this.WeeklyMedalData.responseType = window.YAHOO.util.XHRDataSource.TYPE_JSON;
                ...
                if(wHt > 410) { wHt = 410; }
                this.WeeklyMedalTable = new window.YAHOO.widget.ScrollingDataTable("statsWeeklyMedalTable", this.WeeklyMedalColumns, this.WeeklyMedalData, {
                    width:"100%",
                    height:wHt + "px",
                    initialRequest: Lang.JSON.stringify({
                            "id": window.YAHOO.rpc.Service._requestId++,
...
window.YAHOO.register("stats", window.YAHOO.lacuna.Stats, {version: "1", build: "0"});
