...
if (typeof window.YAHOO.lacuna.Library == "undefined" || !window.YAHOO.lacuna.Library) {
...
(function(){
    ...
    var Library = {
        ...
        planetarySort : function(planets) {
            var ED = window.YAHOO.lacuna.Game.EmpireData;
            var newplanets = [];
    ...
    window.YAHOO.lacuna.Library = Library;
})();
window.YAHOO.register("library", window.YAHOO.lacuna.Library, {version: "1", build: "0"});
