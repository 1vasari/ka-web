...
if (typeof window.YAHOO.lacuna.CreateEmpire == "undefined" || !window.YAHOO.lacuna.CreateEmpire) {
...
(function(){
    ...
    var CreateEmpire = function(Login) {
        ...
        this.Dialog.cfg.queueProperty("keylisteners", new window.YAHOO.util.KeyListener("empirePassConfirm", { keys:13 }, { fn:this.handleCreate, scope:this, correctScope:true } ));
        this.Dialog.render();
    ...
    CreateEmpire.prototype = {
        refreshCaptcha : function() {
            ...
            Game.Services.Empire.fetch_captcha({},{
                success : function(o){
                    window.YAHOO.log(o, "info", "RefreshCaptcha");
        ...
        handleCreate : function() {
            ...
            if(this.savedEmpire && this.savedEmpire.name == this.elName.value) {
                ...
                EmpireServ.create(data,{
                    success : function(o){
                        window.YAHOO.log(o, "info", "CreateEmpire");
    ...
    window.YAHOO.lang.augmentProto(CreateEmpire, Util.EventProvider);

    Lacuna.CreateEmpire = CreateEmpire;
})();
window.YAHOO.register("createEmpire", window.YAHOO.lacuna.CreateEmpire, {version: "1", build: "0"});
