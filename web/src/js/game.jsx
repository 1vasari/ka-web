...
if (typeof window.YAHOO.lacuna.Game === 'undefined' || !window.YAHOO.lacuna.Game) {

    (function() {
        var Util = window.YAHOO.util;
        var Lang = window.YAHOO.lang;
        var Cookie = Util.Cookie;
        var Dom = Util.Dom;
        var Event = Util.Event;
        var Lacuna = window.YAHOO.lacuna;
        ...
        var Game = {
            ...
            OverlayManager : new window.YAHOO.widget.OverlayManager(),
            ...
            Start : function(query) {
                ...
                Game.Services = Game.InitServices(window.YAHOO.lacuna.SMD.Services);
            ...
            InitServices : function(smd) {
                ...
                for (var sKey in smd) {
                    if (smd.hasOwnProperty(sKey)) {
                        var oSmd = smd[sKey];
                        if (oSmd.services) {
                            serviceOut[sKey] = new window.YAHOO.rpc.Service(oSmd, {
                                success : successFunc
                            }, constants.RPC_BASE);
                        } else {
            ...
            WrappedService : function(method, name) {
                ...
                var func = function(params, origOpts) {
                    var retry = function() {
                        var opts = { retry : 0 };
                        window.YAHOO.lang.augmentObject(opts, origOpts, true);
                        opts.retry++;
                        func(params, opts);
                    };
                    var opts = {
                    ...
                    window.YAHOO.lang.augmentObject(opts, origOpts);
                    if (!('timeout' in opts)) {
            ...
            QuickDialog : function(config, afterRender, afterHide) {
                ...
                window.YAHOO.lang.augmentObject(config, {
                    fixedcenter         : true,
                    visible             : false,
                    draggable           : false,
                ...
                var dialog = new window.YAHOO.widget.SimpleDialog(container, config);
            ...
            GetStatus : function(callback) {
                ...
                EmpireServ.get_status({
                    ...
                    success : function(o) {
                        window.YAHOO.log(o, 'info', 'Game.GetStatus.success');
            ...
            StarJump : function(star) {
                window.YAHOO.log(star, 'debug', 'StarJump');
                Game.OverlayManager.hideAll();
            ...
            GetContainerEffect : function(effect) {
                if (Game.GetCookieSettings('disableDialogAnim', '0') === '1') {
                    ...
                    return effect || {
                        effect   : window.YAHOO.widget.ContainerEffect.FADE,
                        duration : 0.5
                    };
                }
            },
            ...
            QueueFire : function(type, id) {
                window.YAHOO.log(arguments, 'debug', 'Game.QueueFire');
                ...
                switch (type) {
                    ...
                    case Lib.QueueTypes.SYSTEM:
                        break;
                    default:
                        window.YAHOO.log('type unknown', 'debug', 'Game.QueueFire');
                        break;
                }
            },
            ...
            onScroll : (function() {
                ...
                } else if (window.YAHOO.env.ua.gecko >= 1.9 && !ua.match(/\brv:1\.9\.0/)) {
        ...
        window.YAHOO.lacuna.Game = Game;
    })();

    window.YAHOO.register('game', window.YAHOO.lacuna.Game, {
        version : '1',
        build   : '0'
    });
}
