...
if (typeof window.YAHOO.lacuna.Messaging == "undefined" || !window.YAHOO.lacuna.Messaging) {
...
(function(){
    ...
    Messaging.prototype = {
        _buildPanel : _.once(function() {
            ...
            this.messagingPanel = new window.YAHOO.widget.Panel(panelId, {
        ...
        _buildAttachmentPanel : _.once(function() {
            ...
            this.attachmentPanel = new window.YAHOO.widget.Panel(panelId, {
                constraintoviewport:true,
                visible:false,
                draggable:true,
                effect:Game.GetContainerEffect(),
        ...
        _createToSelect : function() {
            ...
            var oTextboxList = new window.YAHOO.lacuna.TextboxList("messagingCreateTo", dataSource, { //config options
...
window.YAHOO.register("messaging", window.YAHOO.lacuna.Messaging, {version: "1", build: "0"});
