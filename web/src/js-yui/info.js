...
if (typeof window.YAHOO.lacuna.Info == "undefined" || !window.YAHOO.lacuna.Info) {
...
(function(){
    ...
    Empire.prototype = {
        _createPanel : function() {
            if(!this.Panel) {
                ...
                this.Panel = new window.YAHOO.widget.Dialog(this.id, {
                    constraintoviewport:true,
                    visible:false,
                    draggable:true,
                    postmethod:"none",
                ...
                this.Panel.renderEvent.subscribe(function(){
                    ...
                    this.tabView = new window.YAHOO.widget.TabView(this.id+"Tabs");
    ...
    window.YAHOO.lacuna.Info = {
        Alliance: new Alliance(),
        Empire: new Empire()
    };

})();
window.YAHOO.register("info", window.YAHOO.lacuna.Info, {version: "1", build: "0"});
