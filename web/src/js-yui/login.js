...
if (typeof window.YAHOO.lacuna.Login == "undefined" || !window.YAHOO.lacuna.Login) {
...
(function(){
    ...
    var Login = function() {
        ...
        this.Dialog = new window.YAHOO.widget.Panel(this.id, {
    ...
    Login.prototype = {
        handleLogin : function() {
            ...
            EmpireServ.login( {
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Login.handleLogin.success");
    ...
    var ResetPassword = function(Login) {
        ...
        this.EmailDialog = new window.YAHOO.widget.Dialog(this.emailId, {
            constraintoviewport:true,
            fixedcenter:true,
            visible:false,
            draggable:false,
        ...
        this.ResetDialog = new window.YAHOO.widget.Dialog(this.resetId, {
            constraintoviewport:true,
            fixedcenter:true,
            visible:false,
            draggable:false,
    ...
    ResetPassword.prototype = {
        ...
        sendEmail : function() {
            ...
            Game.Services.Empire.send_password_reset_message(data,{
                success: function(o) {
                    window.YAHOO.log(o, "info", "ResetPassword.sendEmail.success");
        ...
        resetPassword : function() {
            ...
            if (password1 != password2) {
                ...
                Game.Services.Empire.reset_password({
                    ...
                    success: function(o) {
                        window.YAHOO.log(o, "info", "ResetPassword.resetPassword.success");
                        require('js/actions/menu/loader').hide();
...
window.YAHOO.register("login", window.YAHOO.lacuna.Login, {version: "1", build: "0"});
