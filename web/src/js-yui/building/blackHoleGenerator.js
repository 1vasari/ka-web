...
if (typeof window.YAHOO.lacuna.buildings.BlackHoleGenerator == "undefined" ||
           !window.YAHOO.lacuna.buildings.BlackHoleGenerator) {
...
(function(){
  ...
  Lang.extend(BlackHoleGenerator, Lacuna.buildings.Building, {
    ...
    _getBHGTab : function() {
      ...
      this.tab = new window.YAHOO.widget.Tab({ label: "Singularity", content: [
        '<div id="bhgContainer">',
  ...
  window.YAHOO.lacuna.buildings.BlackHoleGenerator = BlackHoleGenerator;

})();
window.YAHOO.register("blackholegenerator", window.YAHOO.lacuna.buildings.BlackHoleGenerator, {version: "1", build: "0"});
