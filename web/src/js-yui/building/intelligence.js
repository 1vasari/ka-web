...
if (typeof window.YAHOO.lacuna.buildings.Intelligence == "undefined" || !window.YAHOO.lacuna.buildings.Intelligence) {
...
(function(){
    ...
    Lang.extend(Intelligence, Lacuna.buildings.Building, {
        ...
        _getTrainTab : function() {
            ...
            this.trainTab = new window.YAHOO.widget.Tab({ label: "Train Spies", content: [
                '<div class="yui-g">',
        ...
        _getSpiesTab : function() {
            this.spiesTab = new window.YAHOO.widget.Tab({ label: "Spies", content: [
                '<div>',
        ...
        _getRenameSpiesTab : function () {
            this.renameTab = new window.YAHOO.widget.Tab({ label: "Rename All", content: [
                '<div>',
            ...
            if(e.newValue) {
                if(!this.spies) {
                    ...
                    this.service.view_spies({session_id:Game.GetSession(),building_id:this.building.id}, {
                        success : function(o){
                            window.YAHOO.log(o, "info", "Intelligence.Intelligence.view_spies.success");
        ...
        SpyHandlePagination : function(newState) {
            ...
            this.service.view_spies({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Intelligence.SpyHandlePagination.view_spies.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
                    this.spies = o.result;
                    this.SpyPopulate();
        ...
        SpyAssign : function() {
            ...
            this.Self.service.assign_spy({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Intelligence.SpyAssign.success");
                    require('js/actions/menu/loader').hide();
        ...
        SpyBurn : function() {
            if(confirm(["Are you sure you want to Burn ",this.Spy.name,"?"].join(''))) {
                ...
                this.Self.service.burn_spy({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "Intelligence.SpyBurn.success");
                        require('js/actions/menu/loader').hide();
                        this.Self.rpcSuccess(o);
                        var spies = this.Self.spies.spies;
                        for(var i=0; i<spies.length; i++) {
        ...
        SpyNameSave : function(e) {
            ...
            this.Self.service.name_spy({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Intelligence.SpyNameSave.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
        ...
        SpyTrain : function() {
            ...
            if(Lang.isNumber(num) && num <= this.result.spies.maximum - this.result.spies.current) {
                ...
                this.service.train_spy({session_id:Game.GetSession(),building_id:this.building.id,quantity:num}, {
                    success : function(o){
                        window.YAHOO.log(o, "info", "Intelligence.SpyTrain.success");
                        require('js/actions/menu/loader').hide();
                        this.rpcSuccess(o);
    ...
    window.YAHOO.lacuna.buildings.Intelligence = Intelligence;

})();
window.YAHOO.register("Intelligence", window.YAHOO.lacuna.buildings.Intelligence, {version: "1", build: "0"});
