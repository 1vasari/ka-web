...
if (typeof window.YAHOO.lacuna.buildings.DistributionCenter == "undefined" || !window.YAHOO.lacuna.buildings.DistributionCenter) {
...
(function(){
    ...
    Lang.extend(DistributionCenter, Lacuna.buildings.Building, {
        ...
        _getReserveTab : function() {
            this.tab = new window.YAHOO.widget.Tab({ label: "Reserve", content: [
...
window.YAHOO.register("DistributionCenter", window.YAHOO.lacuna.buildings.DistributionCenter, {version: "1", build: "0"});
