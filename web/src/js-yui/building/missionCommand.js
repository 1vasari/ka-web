...
if (typeof window.YAHOO.lacuna.buildings.MissionCommand == "undefined" || !window.YAHOO.lacuna.buildings.MissionCommand) {
...
(function(){
    ...
    Lang.extend(MissionCommand, Lacuna.buildings.Building, {
        ...
        _getMissionTab : function() {
            this.missionTab = new window.YAHOO.widget.Tab({ label: "Missions", content: [
                '<div>',
    ...
    window.YAHOO.lacuna.buildings.MissionCommand = MissionCommand;

})();
window.YAHOO.register("MissionCommand", window.YAHOO.lacuna.buildings.MissionCommand, {version: "1", build: "0"});
