...
if (typeof window.YAHOO.lacuna.buildings.MercenariesGuild == "undefined" || !window.YAHOO.lacuna.buildings.MercenariesGuild) {
...
(function(){
    ...
    Lang.extend(MercenariesGuild, Lacuna.buildings.Building, {
        ...
        _getAvailTab : function() {
            this.avail = new window.YAHOO.widget.Tab({ label: "Available Mercs", content: [
                '<div>',
        ...
        _getMineTab : function() {
            this.mine = new window.YAHOO.widget.Tab({ label: "My Mercs", content: ['<div class="myMercenariesGuilds">',
                '    <ul class="tradeHeader tradeInfo clearafter">',
                '        <li class="tradeOfferedDate">Offered Date</li>',
                '        <li class="tradeAsking">Cost</li>',
                '        <li class="tradeOffer">Offering</li>',
        ...
        _getAddTab : function() {
            this.add = new window.YAHOO.widget.Tab({ label: "Add Merc", content: [
            '<div id="aHt">',
        ...
        AvailableAccept : function(e) {
            ...
            this.Self.service.accept_from_market({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "MercenariesGuild.accept_trade.success");
        ...
        MineHandlePagination : function(newState) {
            ...
            this.service.view_my_market({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "MercenariesGuild.view_available_trades.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
...
window.YAHOO.register("trade", window.YAHOO.lacuna.buildings.MercenariesGuild, {version: "1", build: "0"});
