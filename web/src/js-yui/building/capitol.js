...
if (typeof window.YAHOO.lacuna.buildings.Capitol == "undefined" || !window.YAHOO.lacuna.buildings.Capitol) {
...
(function(){
    ...
    window.YAHOO.lang.extend(Capitol, Lacuna.buildings.Building, {
        ...
        _getRenameTab : function() {
            ...
            var tab = new window.YAHOO.widget.Tab({ label: "Rename Empire", contentEl: div});
            return tab;
        },
        RenameEmpire : function(e) {
            ...
            this.service.rename_empire({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Capitol.rename_empire.success");
                    btn.disabled = false;
...
window.YAHOO.register("Capitol", window.YAHOO.lacuna.buildings.Capitol, {version: "1", build: "0"});
