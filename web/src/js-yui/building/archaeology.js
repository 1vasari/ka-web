...
if (typeof window.YAHOO.lacuna.buildings.Archaeology == "undefined" || !window.YAHOO.lacuna.buildings.Archaeology) {
...
(function(){
  ...
  window.YAHOO.extend(DDList, window.YAHOO.util.DDProxy, {
    ...
    endDrag: function(e) {
      ...
      var a = new window.YAHOO.util.Motion(
        proxy, {
          points: {
            to: Dom.getXY(srcEl)
          }
        ...
        0.2,
        window.YAHOO.util.Easing.easeOut
      );
    ...
    onDragDrop: function(e, id) {
      if (id == "archaeologyGlyphDetails") {
        ...
        // The position of the cursor at the time of the drop (window.YAHOO.util.Point)
  ...
  Lang.extend(Archaeology, Lacuna.buildings.Building, {
    ...
    _getSearchTab : function() {
      var tab = new window.YAHOO.widget.Tab({ label: "Search", content: [
    ...
    _getViewTab : function() {
      var tab = new window.YAHOO.widget.Tab({ label: "View Glyphs", content: [
    ...
    _getExcavatorTab : function() {
      this.excavatorTab = new window.YAHOO.widget.Tab({ label: "Excavators", content: [
    ...
    _getAbandonExcavatorTab : function() {
      this.excavatorTab = new window.YAHOO.widget.Tab({ label: "Abandon All Excavators", content: [
    	'<div>',
      ...
      if(e.newValue) {
        if(!this.excavators) {
          ...
          this.service.view_excavators({session_id:Game.GetSession(),building_id:this.building.id}, {
            success : function(o){
              window.YAHOO.log(o, "info", "Archaeology.view_excavators.success");
    ...
    ExcavatorAbandon : function() {
      if(confirm(["Are you sure you want to Abandon the excavator ",this.Excavator.id," at  ",this.Excavator.body.name,"?"].join(''))) {
        ...
        this.Self.service.abandon_excavator({
          ...
          success : function(o){
            window.YAHOO.log(o, "info", "Archaeology.ExcavatorAbandon.success");
            require('js/actions/menu/loader').hide();
...
//wee
    ...
    getOres : function() {
      if(!this.ore) {
        ...
        this.service.get_ores_available_for_processing({session_id:Game.GetSession(),building_id:this.building.id}, {
          success : function(o){
            window.YAHOO.log(o, "info", "Archaeology.getOres.success");
            require('js/actions/menu/loader').hide();
            this.rpcSuccess(o);
    ...
    getGlyphs : function() {
      if(!this.glyphs) {
        ...
        this.service.get_glyphs({session_id:Game.GetSession(),building_id:this.building.id}, {
          success : function(o){
            window.YAHOO.log(o, "info", "Archaeology.getGlyphs.success");
            require('js/actions/menu/loader').hide();
            this.rpcSuccess(o);
    ...
    assembleGlyph : function() {
      ...
      this.service.assemble_glyphs({session_id:Game.GetSession(),building_id:this.building.id, glyphs:glyphTypes, quantity:quantity}, {
        success : function(o){
          window.YAHOO.log(o, "info", "Archaeology.assembleGlyph.success");
    ...
    searchForGlyph : function() {
      ...
      if(type) {
        this.service.search_for_glyph({session_id:Game.GetSession(),building_id:this.building.id,ore_type:type}, {
          success : function(o){
            window.YAHOO.log(o, "info", "Archaeology.searchForGlyph.success");
            require('js/actions/menu/loader').hide();
            this.rpcSuccess(o);
    ...
    AbandonAllExcavators : function(e) {
        if(confirm("Are you sure you want to abandon all excavators controlled by this Archaeology Ministry?")) {
            ...
            this.service.mass_abandon_excavator({
                ...
                success : function(o){
                     window.YAHOO.log(o, "info", "Archaeology.AbandonAllExcavators.mass_abandon_excavator.success");
                     require('js/actions/menu/loader').hide();
                     this.rpcSuccess(o);
                     this.probes = null;
...
window.YAHOO.register("archaeology", window.YAHOO.lacuna.buildings.Archaeology, {version: "1", build: "0"});
