...
if (typeof window.YAHOO.lacuna.buildings.TheDillonForge == "undefined" || !window.YAHOO.lacuna.buildings.TheDillonForge) {
...
(function(){
    ...
    Lang.extend(TheDillonForge, Lacuna.buildings.Building, {
        ...
        _getForgeTab : function() {
            this.splitTab = new window.YAHOO.widget.Tab({ label: "Forge", content: [
        ...
        MakePlan : function() {
            ...
            this.Self.service.make_plan(
                ...
                {
                    success : function(o){
                        window.YAHOO.log(o, "info", "TheDillonForge.MakePlan.success");
        ...
        SplitPlan : function() {
            ...
            if ( selected.length == 3 ) {
                ...
                this.Self.service.split_plan(
                    ...
                    {
                        success : function(o){
                            window.YAHOO.log(o, "info", "TheDillonForge.SplitPlan.success");
                            require('js/actions/menu/loader').hide();
                            this.Self.rpcSuccess(o);
                            this.Self.result = o.result;
                            this.Self.viewForgeTab();
        ...
        Subsidize : function() {
            ...
            this.Self.service.subsidize({session_id:Game.GetSession(),building_id:this.Self.building.id}, {
                success : function(o){
                    window.YAHOO.log(o, "info", "TheDillonForge.Subsidize.success");
                    require('js/actions/menu/loader').hide();
                    this.Self.rpcSuccess(o);
                    this.Self.result = o.result;
                    this.Self.viewForgeTab();
    ...
    window.YAHOO.lacuna.buildings.TheDillonForge = TheDillonForge;

})();
window.YAHOO.register("TheDillonForge", window.YAHOO.lacuna.buildings.TheDillonForge, {version: "1", build: "0"});
