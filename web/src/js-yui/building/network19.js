...
if (typeof window.YAHOO.lacuna.buildings.Network19 == "undefined" || !window.YAHOO.lacuna.buildings.Network19) {
...
(function(){
    ...
    Lang.extend(Network19, Lacuna.buildings.Building, {
        ...
        _getCoverageTab : function() {
            this.coverageTab = new window.YAHOO.widget.Tab({ label: "Coverage", content: [
        ...
        NewsCoverage : function(e) {
            ...
            this.service.restrict_coverage({session_id:Game.GetSession(),building_id:this.result.building.id,onoff:isRestrict}, {
                success : function(o){
                    window.YAHOO.log(o, "info", "Network19.NewsCoverage.restrict_coverage.success");
        ...
        NewsGet : function() {
            ...
            this.service.view_news({session_id:Game.GetSession(),building_id:this.building.id}, {
                success : function(o){
                    window.YAHOO.log(o, "info", "Network19.NewsGet.success");
                    require('js/actions/menu/loader').hide();
                    this.rpcSuccess(o);
    ...
    window.YAHOO.lacuna.buildings.Network19 = Network19;

})();
window.YAHOO.register("network19", window.YAHOO.lacuna.buildings.Network19, {version: "1", build: "0"});
