...
if (typeof window.YAHOO.lacuna.MapStar == "undefined" || !window.YAHOO.lacuna.MapStar) {
...
(function(){
    ...
    MapStar.prototype = {
        _buildDetailsPanel : _.once(function() {
            ...
            this.starDetails = new window.YAHOO.widget.Panel(panelId, {
            ...
            this.starDetails.renderEvent.subscribe(function(){
                this.starDetails.tabView = new window.YAHOO.widget.TabView("starDetailTabs");
        ...
        _buildPlanetDetailsPanel : _.once(function() {
            ...
            this.planetDetails = new window.YAHOO.widget.Panel(panelId, {
                constraintoviewport:true,
                visible:false,
                draggable:true,
                effect:Game.GetContainerEffect(),
            ...
            this.planetDetails.renderEvent.subscribe(function(){
                ...
                var tv = this.planetDetails.tabView = new window.YAHOO.widget.TabView("planetDetailTabs");
        ...
        _buildFindPanel : _.once(function() {
            ...
            this.starFind = new window.YAHOO.widget.Panel(panelId, {
                constraintoviewport:true,
                visible:false,
                draggable:true,
                effect:Game.GetContainerEffect(),
            ...
            this.starFind.createFind = function() {
                ...
                var oTextboxList = new window.YAHOO.lacuna.TextboxList(this.findInput, dataSource, { //config options
        ...
        MapVisible : function(visible) {
            ...
            if(this._isVisible != visible) {
                if(this._elGrid) {
                    ...
                    window.YAHOO.log(visible, "info", "MapStar.MapVisible");
                    if(visible) {
        ...
        ShipSend : function() {
            ...
            if(target && oSelf.NotIsolationist(ship)) {
                Game.Services.Buildings.SpacePort.send_ship({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "MapStar.ShipSend.send_ship.success");
                        require('js/actions/menu/loader').hide();
        ...
        GetShips : function(panel, target) {
            if(!this.currentShips) {
                ...
                Game.Services.Buildings.SpacePort.get_ships_for({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "MapStar.ShowStar.get_ships_for.success");
                        require('js/actions/menu/loader').hide();
                        this.fireEvent("onMapRpc", o.result);
        ...
        ShowPlanet : function(tile, keepOpen) {
            ...
            Game.Services.Body.get_body_status(data, {
                success : function(o){
                    window.YAHOO.log(o, "info", "ShowPlanet.get_status.success");
            ...
            panel.show();
                    ...
                    failure : function(o){
                        window.YAHOO.log(o, "info","ShowPlanet.get_status.fail");
        ...
        Rename : function() {
            ...
            Game.Services.Body.rename({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "MapStar.Rename.success");
                        if(o.result && this.selectedBody) {
                            ...
                            if(this.selectedTile instanceof window.YAHOO.lacuna.Mapper.StarTile) {
        ...
        ShowSpies : function(tab) {
            ...
            Game.Services.Buildings.SpacePort[method](data,{
                success : function(o){
                    window.YAHOO.log(o, "info", "MapStar.ShowSpies."+method+".success");
                    this.fireEvent("onMapRpc", o.result);
                    require('js/actions/menu/loader').hide();
                    tab.avail = {
...
window.YAHOO.register("mapStar", window.YAHOO.lacuna.MapStar, {version: "1", build: "0"});
