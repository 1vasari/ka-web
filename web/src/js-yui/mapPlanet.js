...
if (typeof window.YAHOO.lacuna.MapPlanet == "undefined" || !window.YAHOO.lacuna.MapPlanet) {
...
(function(){
    ...
    MapPlanet.prototype = {
        _buildDetailsPanel : _.once(function() {
            ...
            this.buildingDetails = new window.YAHOO.widget.Panel(panelId, {
            ...
            this.buildingDetails.renderEvent.subscribe(function(){
                ...
                this.tabView = new window.YAHOO.widget.TabView("buildingDetailTabs");
        ...
        _buildBuilderPanel : _.once(function() {
            ...
            this.buildingBuilder = new window.YAHOO.widget.Panel(panelId, {
                constraintoviewport:true,
                visible:false,
                draggable:true,
                effect:Game.GetContainerEffect(),
        ...
        MapVisible : function(visible) {
            if(this._isVisible != visible) {
                if(this._elGrid) {
                    ...
                    //window.YAHOO.log(visible, "info", "MapPlanet.MapVisible");
                    if(visible) {
        ...
        Mapper : function(oArgs) {
            //window.YAHOO.log(oArgs.buildings, "debug", "Mapper");
        ...
        Refresh : function() {
            if(this.locationId) {
                ...
                BodyServ.get_buildings(data,{
                    success : function(o){
                        //window.YAHOO.log(o, "info", "MapPlanet.Refresh");
        ...
        ReLoad : function(silent) {
            if(this.locationId) {
                ...
                BodyServ.get_buildings(data,{
                    success : function(o){
                        //window.YAHOO.log(o, "info", "MapPlanet.ReLoad");
                        this.fireEvent("onMapRpc", o.result);
                        if(silent) {
                            require('js/actions/menu/loader').hide();
                        }
        ...
        ReLoadTile : function(id) {
            //window.YAHOO.log(this._isVisible, "info", "MapPlanet.ReLoadTile._isVisible");
            if(this._isVisible && id) {
                //window.YAHOO.log(id, "info", "MapPlanet.ReLoadTile.id");
                var building = this.buildings[id];
                if(building) {
                    //window.YAHOO.log(building, "info", "MapPlanet.ReLoadTile.building");
        ...
        BuilderView : function(tile) {
            //window.YAHOO.log(tile, "info", "BuilderView");
        ...
        BuilderGet : function(data) {
            ...
            this.currentBuildConnection = Game.Services.Body.get_buildable(data,{
                success : function(o){
                    ...
                    //window.YAHOO.log(o, "info", "MapPlanet.BuilderGet.success");
                    this.fireEvent("onMapRpc", o.result);
        ...
        Build : function(building, x, y) {
            ...
            BuildingServ.build(data,{
                success : function(o){
                    //window.YAHOO.log(o, "info", "MapPlanet.Build.success");
                    require('js/actions/menu/loader').hide();
                    this.fireEvent("onMapRpc", o.result);
                    ...
                    b.x = x;
                    b.y = y;
                    //window.YAHOO.log(b, "info", "MapPlanet.Build.success.building");
        ...
        ViewData : function(id, url, callback, x, y) {
            ...
            return BuildingServ.view(data,{
                success : function(o){
                    //window.YAHOO.log(o, "info", "MapPlanet.ViewData.success");
                    this.fireEvent("onMapRpc", o.result);
        ...
        DetailsView : function(tile) {
            //window.YAHOO.log(tile, "info", "DetailsView");
                    ...
                    if(building.pending_build.seconds_remaining > 0) {
                        panel.addQueue(building.pending_build.seconds_remaining,
                            function(remaining, elm){
                                ...
                                if(rf <= 0) {
                                    elm.innerHTML = "";
                                    window.YAHOO.log("Complete","info","buildingDetails.showEvent.BuildTimeRemaining");
        ...
        ReloadBuilding : function(building) {
            //window.YAHOO.log(building, "debug", "ReloadBuilding");
            ...
            window.YAHOO.log({b:building, time:ms}, "debug", "MapPlanet.ReloadBuilding");
...
window.YAHOO.register("mapPlanet", window.YAHOO.lacuna.MapPlanet, {version: "1", build: "0"});
