...
if (typeof window.YAHOO.lacuna.buildings.Building == "undefined" || !window.YAHOO.lacuna.buildings.Building) {
    ...
    Building.prototype = {
        ...
        */
        ...
        _getRepairTab : function() {
            this.repairTab = new window.YAHOO.widget.Tab({ label: "Repair", content: [
        ...
        Repair : function(e) {
            ...
            Game.Services.Buildings.Generic.repair({session_id:Game.GetSession(),building_id:this.building.id}, {
                success : function(o){
                    window.YAHOO.log(o, "info", "Building.Repair.repair.success");
        ...
        _getProductionTab : function() {
            ...
            this.productionTab = new window.YAHOO.widget.Tab({ label: "Production", content: [
        ...
        Demolish : function() {
            ...
            if(confirm(['Are you sure you want to Demolish the level ',building.level,' ',building.name,'?'].join(''))) {
                ...
                Game.Services.Buildings.Generic.demolish({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "Building.Demolish.success");
                        require('js/actions/menu/loader').hide();
                        this.rpcSuccess(o);
        ...
        Downgrade : function() {
            ...
            if(confirm(['Are you sure you want to downgrade the level ',building.level,' ',building.name,'?'].join(''))) {
                ...
                Game.Services.Buildings.Generic.downgrade({
                    ...
                    success : function(o){
                        window.YAHOO.log(o, "info", "Building.Downgrade.success");
                        require('js/actions/menu/loader').hide();
                        this.fireEvent("onMapRpc", o.result);
                        ...
                        window.YAHOO.log(b, "info", "Building.Upgrade.success.building");
        ...
        Upgrade : function() {
            ...
            BuildingServ.upgrade(data,{
                success : function(o){
                    window.YAHOO.log(o, "info", "Building.Upgrade.success");
                    require('js/actions/menu/loader').hide();
                    this.fireEvent("onMapRpc", o.result);
        ...
        _getIncomingSupplyChainsTab : function() {
            this.incomingSupplyChainTab = new window.YAHOO.widget.Tab({ label: "Supply Chains", content: [
        ...
        viewIncomingSupplyChainInfo : function(e) {
            ...
            if ( !this.incoming_supply_chains ) {
                ...
                this.service.view_incoming_supply_chains({session_id:Game.GetSession(),building_id:this.building.id}, {
                    success : function(o){
                        window.YAHOO.log(o, "info", "building.viewIncomingSupplyChainInfo.success");
                        require('js/actions/menu/loader').hide();
                        this.rpcSuccess(o);
        ...
        _getStorageTab : function() {
            var p = this.building.upgrade.production,
                ...
                '    </div>',
                '</div>'];
            return new window.YAHOO.widget.Tab({ label: "Storage", content: output.join('')});
        }
    };
    Lang.augmentProto(Building, Util.EventProvider);

    window.YAHOO.lacuna.buildings.Building = Building;

})();
window.YAHOO.register("building", window.YAHOO.lacuna.buildings.Building, {version: "1", build: "0"});
