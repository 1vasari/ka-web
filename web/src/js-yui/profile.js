...
if (typeof window.YAHOO.lacuna.Profile == "undefined" || !window.YAHOO.lacuna.Profile) {
...
(function(){
    ...
    Profile.prototype = {
        build: _.once(function() {
            ...
            this.Dialog = new window.YAHOO.widget.Dialog(this.id, {
            ...
            this.Dialog.renderEvent.subscribe(function(){
              ...
              Dom.get("profileSkipExcavatorReplaceMsg").checked = true;
                ...
                this.tabView = new window.YAHOO.widget.TabView("profileTabs");
                //species tab
                ...
                this.tabView.getTab(2).subscribe("activeChange", function(e) {
                    if(e.newValue && !this.hasSpecies) {
                        ...
                        Game.Services.Empire.view_species_stats({session_id:Game.GetSession("")},{
                            success : function(o){
                                window.YAHOO.log(o, "info", "Profile.show.view_stats.success");
                        ...
                        Game.Services.Empire.redefine_species_limits({session_id:Game.GetSession("")},{
                            success : function(o){
                                window.YAHOO.log(o, "info", "Profile.redefine_species_limits.success");
                                this.fireEvent('onRpc', o.result);
            ...
            this.SpeciesDialog = new window.YAHOO.widget.Dialog(this.speciesId, {
                constraintoviewport:true,
                postmethod:"none",
                buttons:[
      ...
      '               </ul></div>',
        ...
        handleUpdate : function() {
            ...
            if (this.new_password.value != "") {
                if (this.new_password.value != this.confirm_password.value) {
                    ...
                    Game.Services.Empire.change_password({
                        ...
                        success : function(o){
                            window.YAHOO.log(o, "info", "Profile.handleUpdate.password.success");
            ...
            if(Game.GetCookieSettings("hidePlanets","0") != (this.hidePlanets.checked ? "1" : "0")) {
                ...
                if(window.YAHOO.lacuna.MapStar.IsVisible()){
                    window.YAHOO.lacuna.MapStar._map.hidePlanets = Game.GetCookieSettings("hidePlanets", 0)*1;
                    window.YAHOO.lacuna.MapStar._map.redraw();
                }
            }
            ...
            Game.Services.Empire.edit_profile({
                ...
                success : function(o){
                    window.YAHOO.log(o, "info", "Profile.handleUpdate.success");
                    if (--updatesLeft == 0) {
                        this.hide();
                    }
                },
        ...
        redefineSpecies : function() {
            ...
            Game.Services.Empire.redefine_species({session_id:Game.GetSession(""), params:data},{
                success : function(o){
                    window.YAHOO.log(o, "info", "Profile.redefine_species.success");
...
window.YAHOO.register("profile", window.YAHOO.lacuna.Profile, {version: "1", build: "0"});
