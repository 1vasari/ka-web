...
if (typeof window.YAHOO.lacuna.SpeciesDesigner == "undefined" || !window.YAHOO.lacuna.SpeciesDesigner) {
...
(function(){
    var Util = window.YAHOO.util,
        ...
        Game = Lacuna.Game,
        Slider = window.YAHOO.widget.Slider,
        Lib = Lacuna.Library;
    ...
    SpeciesDesigner.prototype = {
        ...
        _createTooltips : function() {
            this._affinityTooltip = new window.YAHOO.widget.Tooltip(Dom.generateId(), {
                //iframe:true,
                zIndex:1,
        ...
        _createHabitableOrbits : function () {
            ...
            window.YAHOO.lang.augmentObject(slider, {
        ...
        validateSpecies : function(data) {
            if (data.affinity_total > 45) {
                ...
                if (window.confirm("Setting an affinity to 1 is an expert setting, and is not recommended unless you're absolutely sure you know what you're doing.  Are you sure you want to continue?")) {
                    this._expert = true;
                }
                else {
                    return false;
    ...
    //window.YAHOO.lang.augmentProto(SpeciesDesigner, Util.EventProvider);

    Lacuna.SpeciesDesigner = SpeciesDesigner;
})();
window.YAHOO.register("speciesDesigner", window.YAHOO.lacuna.SpeciesDesigner, {version: "1", build: "0"});
